...
int main(void)
{
  ...
  double magnetDistance = 3.5;
  int prevHallVal = 0;
  int prevHallMillis = HAL_GetTick();
  /* USER CODE END Init */
  ...
  while (1)
  {
	int currHallVal = HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_2);
	if (prevHallVal == GPIO_PIN_RESET && currHallVal != prevHallVal) {
